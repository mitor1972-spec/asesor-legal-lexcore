...
export default function LawfirmPortada() {
  ...
  const features = [
    { icon: Zap, title: 'Leads exclusivos', desc: 'Cada caso asignado a un único despacho' },
    { icon: Shield, title: 'Garantía de calidad', desc: 'Sistema de control e incidencias' },
